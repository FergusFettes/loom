...
class JanusPlayground(Module):
    ...
    def build(self, parent):
        ...
        self.textbox.bind("<Alt-period>", lambda _: self.insert_inline_completion(step=1))
        self.textbox.bind("<Alt-comma>", lambda _: self.insert_inline_completion(step=-1))
        self.textbox.bind("<Command-period>", lambda _: self.insert_inline_completion(step=1))
        self.textbox.bind("<Command-comma>", lambda _: self.insert_inline_completion(step=-1))
